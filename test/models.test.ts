  ...
  const ad = new Ad(
    {
      ...
      subject: "Maison",
      price_cents: 123_400,
      images: { urls_large: ["https://image"] },
      attributes: [{ key: "square", value: "100" }],
      location: { city: "Paris" },
      owner: { user_id: "seller" },
    },
    client,
  );
...
test("parses search counters and ads", () => {
  const search = new Search(
    { total: 1, max_pages: 1, ads: [{ list_id: 42, images: {}, location: {}, owner: {} }] },
    { getUser: async () => new User({}) },
  );
